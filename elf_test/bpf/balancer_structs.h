...
struct core_l3_stats {
  ...
  __u32 ipv6_hdr_err;
  __u32 drop_fragment;
  __u32 ipv6_encap_err;
  __u32 ipv4_encap_err;
};

struct core_l4_stats {
  __u64 tcp;
  __u64 udp;
  __u64 icmp;
  __u64 icmp6;
...
union core_stats {
  struct core_total_stats total;
  struct core_l3_stats l3;
  struct core_l4_stats l4;
};

struct core_stats_set {
  __u64 flags;
  union core_stats *total;
  union core_stats *l3;
  union core_stats *l4;
  struct lb_stats  *conn;
  struct lb_stats  *vip_conn;
};
